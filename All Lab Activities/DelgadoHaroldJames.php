                ...
                extend:{
                    fontFamily:{
                        sans:['Poppins','UI-sans-serif','system-ui'],
                             display:['Space Grostesk','UI-sans-serif']
...
<header class="bg-blue-500 text-white p-4">
    <div class="container mx-auto">
        <h1 class="font-display text-3xl font-semibold traking-tight">Job Listings</h1>
    </div>
</header>
...
<div class="container mx-auto p-4 mt-4">
    ...
    <?php foreach ($listings as $index => $job): ?>
        <div class="my-4">
            <?php if($index % 2 === 0): ?>
            <div class="bg-sky-200 rounded-lg shadow-md">
            <?php else: ?>
            <div class="bg-yellow-100 rounded-lg shadow-md">
            <?php endif; ?>
                <div class="p-4">
                    ...
                    <ul class="mt-4">
                        ...
                        <li class="mb-2">
                            ...
                            <?= $job['location'] ?>
                            <?= $job['location'] === 'New York'? '<span class="inline-flex items-center px-2 py-1 text-xs font-medium text-white rounded-full bg-blue-500 border border-blue-600 ml-2">Remote</span>' : '<span class="inline-flex items-center px-2 py-1 text-xs font-medium text-white rounded-full bg-red-500 border border-red-600 ml-2">Onsite</span>' ?>
                             </li>
